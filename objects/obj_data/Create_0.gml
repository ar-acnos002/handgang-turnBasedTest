...
//
//fire moves
burnBiteList = [5, true, "BURN", undefined, undefined, "ENEMY", 6]
flameTackleList = [10, false, undefined, undefined, undefined, undefined, 1]
...
//water moves
waterWhipList = [6, true, "SPEED", "MINUS", 2, "ENEMY", 4]
hydroBashList = [8, false, undefined, undefined, undefined, undefined, 1]
...
furWaterDefense = [1,1,0.75,1,1,0]
...
//SPECIES INDEX
//
speciesIndex = ds_map_create()
ds_map_add(speciesIndex, "Alpha", 0)
ds_map_add(speciesIndex, "Fur", 1)
ds_map_add(speciesIndex, "Feather", 2)
ds_map_add(speciesIndex, "Slime", 3)
ds_map_add(speciesIndex, "Scale", 4)
ds_map_add(speciesIndex, "Crust", 5)
ds_map_add(speciesIndex, "Dragon", 6)
ds_map_add(speciesIndex, "Chimera", 7)
ds_map_add(speciesIndex, "Spirit", 8)
ds_map_add(speciesIndex, "Delta", 9)
//////

//ATTACK MULTIPLIERS
//
//fire type attack list
fireAttackList = [0,1.5,1,0,0,0,2,1.75,1.75,2.5]

//water type attack list
waterAttackList = [0,1,0.5,1.5,2,1,1.75,1.5,1.75,0]

//attack chart initialize
attackMultiplier = ds_map_create()
ds_map_add(attackMultiplier, "Fire", fireAttackList)
ds_map_add(attackMultiplier, "Water", waterAttackList)
//////